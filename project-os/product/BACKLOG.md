...
- IDs are `T-NNNN`, assigned sequentially, never reused. Next ID: **T-0010**.
...
| 4 | [T-0009](tickets/T-0009-role-authorisation-and-user-projection.md) | Role-based authorisation and the user projection from token claims | feature | backlog | T-0001, T-0003 |
