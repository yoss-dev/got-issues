...
- IDs are `T-NNNN`, assigned sequentially, never reused. Next ID: **T-0015**.
...
| --- | --- | --- | --- | --- | --- |
| 1 | [T-0001](tickets/T-0001-runnable-compose-stack.md) | Runnable Docker Compose stack with API skeleton and PostgreSQL | technical | in-progress | — |
| 2 | [T-0011](tickets/T-0011-spike-aspnetcore-generator-viability.md) | SPIKE: is OpenAPI Generator's aspnetcore output workable on ASP.NET Core 10? | spike | in-acceptance | — |
...
| 8 | [T-0005](tickets/T-0005-create-and-read-issues.md) | Create and read issues within a project | feature | backlog | T-0004 |
| 9 | [T-0006](tickets/T-0006-issue-lifecycle-fields.md) | Track an issue's lifecycle — type, status, priority, assignee | feature | backlog | T-0005, T-0009 |
| 10 | [T-0007](tickets/T-0007-list-and-filter-issues.md) | List and filter a project's issues, paginated | feature | backlog | T-0006 |
| 11 | [T-0008](tickets/T-0008-comment-on-an-issue.md) | Comment on an issue | feature | backlog | T-0005, T-0009 |
| 12 | [T-0012](tickets/T-0012-pin-container-base-images.md) | Pin container base images to immutable digests | technical | backlog | T-0001 |
| 13 | [T-0014](tickets/T-0014-correct-testing-standard-commands.md) | Correct TESTING.md's suite commands to match reality | technical | backlog | — |
| 14 | [T-0013](tickets/T-0013-enforce-migration-boundary-with-db-privileges.md) | Enforce the migration boundary with database privileges, not convention | technical | backlog | T-0001 |
