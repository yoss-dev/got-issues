...
- Files: `ADR-NNNN-short-slug.md` in this directory. IDs sequential, never reused. Next ID: **ADR-0011**.
...
| [ADR-0009](ADR-0009-controllers-talk-to-the-dbcontext-and-invariants-are-extracted.md) | Controllers talk to the DbContext directly; only domain invariants are extracted | Superseded by ADR-0010 | 2026-08-31 |
| [ADR-0010](ADR-0010-clean-architecture-layering.md) | Adopt Clean Architecture layering — domain, application ports, infrastructure adapters | Accepted | 2026-08-31 |
