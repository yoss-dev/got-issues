...
> **State: mostly built (2026-08-31).** The Compose stack, API service, database, identity host ([T-0010](../product/tickets/T-0010-duende-identity-host.md)), contract-first pipeline ([T-0002](../product/tickets/T-0002-contract-first-codegen-pipeline.md)) and role authorisation with the user projection ([T-0009](../product/tickets/T-0009-role-authorisation-and-user-projection.md)) all describe code that exists, and the stack's own start-up, restart and token-validation behaviour is now covered by an automated check ([T-0015](../product/tickets/T-0015-compose-stack-smoke-test.md), run with `tools/smoke.sh`) rather than by hand. Two product resources are built: **projects**, created by an `admin` and listed by either role ([T-0004](../product/tickets/T-0004-create-and-list-projects.md)), and **issues**, created within a project and numbered per project ([T-0005](../product/tickets/T-0005-create-and-read-issues.md)). What remains intended rather than built: an issue's **lifecycle fields** ([T-0006](../product/tickets/T-0006-issue-lifecycle-fields.md)), **listing and filtering** ([T-0007](../product/tickets/T-0007-list-and-filter-issues.md)) and **comments** ([T-0008](../product/tickets/T-0008-comment-on-an-issue.md)).
>
