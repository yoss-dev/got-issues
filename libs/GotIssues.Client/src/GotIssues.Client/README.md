...
additionalProperties:
  packageGuid: '{7C2A9E14-5D83-4B67-9F0A-2E6C1B8D4A93}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            var api = host.Services.GetRequiredService<IIssuesApi>();
            ICreateIssueApiResponse apiResponse = await api.CreateIssueAsync("todo");
            Issue? model = apiResponse.Ok();
        }
...
## Api Information
- appName: Got Issues API
- appVersion: 0.1.0
- appDescription: A self-hosted, API-first issue and task tracker for internal engineering work.  This document is the product&#39;s user-facing documentation as well as its contract: every operation and schema is described for a reader who has never seen the implementation. 
